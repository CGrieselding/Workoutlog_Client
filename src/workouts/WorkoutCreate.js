    ...
    return(
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <FormGroup>
                ...
                <Input type="select" name="defintion" value={definition} onChange={(e) => setDefinition(e.target.value)}>
            ...
            <Button type="submit" style={{margin: '20px 0 10px 0'}}>Click to Submit</Button>
        </Form>
        </>
    )
};
